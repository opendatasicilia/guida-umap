...
## Visualizza il controllo di zoom  :octicons-zoom-in-24:  :octicons-zoom-out-24:
...
## Visualizza il controllo di ricerca  :octicons-search-24:
...
## Visualizza il controllo di schermo intero  :material-fullscreen:
...
## Visualizza il controllo per l'incorporamento :octicons-share-android-24:
...
## Visualizza il controllo di misurazione  :straight_ruler:
...
## Mostra il controllo per aprire l'editor di OpenStreetMap  :simple-openstreetmap:
...
## Mostra il controllo dei dati per i layer  :fontawesome-solid-layer-group:
...
## Visualizza il controllo del livello del tile  :material-layers-search-outline: 
...
## Visualizza il pulsante per aggiungere una mappa come speciale :star:
...
## Visualizzare il controllo "altro" :octicons-arrow-down-24:
...
## Abilitare la rotellina del mouse per lo zoom  :mouse_three_button:
...
## Visualizzare una mappa panoramica  :material-panorama:
...
## Visualizzare la scala  :octicons-number-24:
...
## Visualizza un panello al caricamento  :material-solar-panel:
...
## Vista predefinita  :material-cursor-default-click:
...
## Visualizzare la finestra di pop up a piè di pagina  :material-page-layout-footer:
...
## Visualizzare una didascalia  :material-subtitles-outline:

Attivando questa funzione (**`on`**) viene visualizzata un piccolo footer con il titolo della mappa.


## Visualizzare le etichette dei menù  :material-label-multiple:
